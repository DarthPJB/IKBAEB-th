...
Cons
- Finger travel is terrible. (if use 1 finger)

# How compile

1. [How to create a Language-Pack](https://github.com/AnySoftKeyboard/AnySoftKeyboard/blob/master/addons/CONTRIBUTING.md)
